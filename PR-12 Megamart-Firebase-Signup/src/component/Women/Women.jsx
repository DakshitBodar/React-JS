...
import { DeleteWomenDataAsync, GetAllWomenAsync } from "../../services/action/MenAction";
...
const Womenproduct = () => {
  ...
  const handleDelete = id => dispatch(DeleteWomenDataAsync(id));
  ...
  return (
    <div className="menproduct-container">
      ...
      <div className="filter-sidebar">
        ...
        <Button variant="secondary" size="sm" className="w-100" onClick={resetFilters}>
          Reset Filters
        </Button>
      </div>
